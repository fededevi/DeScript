...
JJSimpleString addUnicodeEscapes(const JJString& str);
  ...
  class AlpiScript;
  class ErrorHandler {
    friend class AlpiScriptTokenManager;
    friend class AlpiScript;
    protected:
      int error_count;
    public:
      ...
      virtual void handleUnexpectedToken(int expectedKind, const JJString& expectedToken, Token *actual, AlpiScript *parser) {
        error_count++;
      ...
      virtual void handleParseError(Token *last, Token *unexpected, const JJSimpleString& production, AlpiScript *parser) {
        error_count++;
      ...
      virtual void handleOtherError(const JJString& message, AlpiScript *parser) {
  ...
  class TokenManagerErrorHandler {
    ...
    public:
       ...
       //
       virtual void lexicalError(bool EOFSeen, int lexState, int errorLine, int errorColumn, const JJString& errorAfter, JJChar curChar, AlpiScriptTokenManager* token_manager) {
       ...
       virtual void lexicalError(const JJString& errorMessage, AlpiScriptTokenManager* token_manager) {
...
/* JavaCC - OriginalChecksum=33e5ed87df3058a58567ba1deec2b6ae (do not edit this line) */

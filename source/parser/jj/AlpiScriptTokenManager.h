#ifndef ALPISCRIPTTOKENMANAGER_H
#define ALPISCRIPTTOKENMANAGER_H
#include "stdio.h"
#include "JavaCC.h"
...
/** Token Manager. */
class AlpiScriptTokenManager : public TokenManager {
public:
...
public:
  AlpiScriptTokenManager(JAVACC_CHARSTREAM *stream, int lexState = 0);
  virtual ~AlpiScriptTokenManager();
